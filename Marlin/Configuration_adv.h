 ...
 */
   ...
   * below 2.
   */
  #define WATCH_TEMP_PERIOD  16               // Seconds /// MOD SANDOR (20) ///
 ...
 */
  ...
  #define THERMAL_PROTECTION_BED_PERIOD        60 // Seconds /// MOD SANDOR (20) ///
  #define THERMAL_PROTECTION_BED_HYSTERESIS     2 // Degrees Celsius

  /**
   * As described above, except for the bed (M140/M190/M303).
   */
  #define WATCH_BED_TEMP_PERIOD                120 // Seconds /// MOD SANDOR (60) ///
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 30*60, 30*60, 10*60, 2*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
